...
public color[] inventory_color = new color[5];
int current_position = 0;
int current;

public int playerX = 120;
public int playerY = 120;
...
void drawInventory() {
  ...
  rect(screnWidth/2, screnHeight-60, 40, 40);
  setColor(inventory_color[1]);
  rect(screnWidth/2+40, screnHeight-60, 40, 40);
  setColor(inventory_color[2]);
  rect(screnWidth/2+80, screnHeight-60, 40, 40);
  setColor(inventory_color[3]);
  rect(screnWidth/2+120, screnHeight-60, 40, 40);
  setColor(inventory_color[4]);
  rect(screnWidth/2+160, screnHeight-60, 40, 40);
}
